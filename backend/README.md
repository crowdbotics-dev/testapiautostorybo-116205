...
## Project Structure
    ...
    ├── testapiautostorybo_116205  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_116205`
...
2. Clone this repo and `cd testapiautostorybo_116205`
